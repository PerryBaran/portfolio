...
const NextJS = new Logo(require('./NextJS.png'), 'Next JS')


export { CSS3, Firebase, GitHub, HTML5, Jest, JavaScript, React, TypeScript, Git, Node, Mocha, Docker, MySQL, Sequelize, Express, AWS, PostgreSQL, NextJS };